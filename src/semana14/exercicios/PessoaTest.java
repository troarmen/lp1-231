...
public class PessoaTest {
    ...
    public void retornaAltura(){
        ...
        assertEquals(pessoa.getAltura(), 1.72);
    }
    ...
    public void modificaAlturaZero(){
        ...
        try {
            ...
            assertEquals(e.getMessage(), "Altura inválida. Digite um valor positivo");
        }
    }
    ...
    @Test
    public void retornaPeso(){
        Pessoa pessoa = new Pessoa(1.72, 50);

        assertEquals(pessoa.getPeso(), 50);
    }

    @Test
    public void modificaPesoPositivo(){
        Pessoa pessoa = new Pessoa(1.72, 50);
        
        pessoa.setPeso(60);

        assertEquals(pessoa.getPeso(), 60);
    }

    @Test
    public void modificaPesoZero(){
        Pessoa pessoa = new Pessoa(1.72, 50);

        try {
            pessoa.setPeso(0);
        } catch (RuntimeException e) {
            assertEquals(e.getMessage(), "Peso inválido. Digite um valor positivo");
        }
    }

    @Test
    public void modificaPesoNegativo(){
        Pessoa pessoa = new Pessoa(1.72, 50);
